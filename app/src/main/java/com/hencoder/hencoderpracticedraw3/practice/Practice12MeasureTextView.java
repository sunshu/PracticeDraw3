...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float f1 = paint1.measureText(text1, 0, text1.length());
        canvas.drawText(text2, 50 + f1, 200, paint2);
        float f2 = paint2.measureText(text2,0,text2.length());
        canvas.drawText(text3, 50 + f1+f2, 200, paint1);
    }
}
